...
def run_simu(FF ,solvers:list[SEMI_solver|SGM_solver], shape='CC'):
    ...
    n_list = [2.46, 2.46, 2.38, 2.47, 2.46]
    t_list = [0.25, 0.385-0.25, 0.005, 0.875, 3.0]
    is_phc = [True, False, False, False, False]
    is_no_doping = [False, False, True, True, False]
    mat_list = []
    ...
    model_size = int(300/cwt_solver.a) # 300 um
...
if __name__ == '__main__':
    ...
    df.to_csv('GaN_data_set_250nm.csv', index=False)
